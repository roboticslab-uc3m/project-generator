...
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "TEMPLATE_DESCRIPTION")
set(CPACK_PACKAGE_DESCRIPTION_FILE "${CMAKE_SOURCE_DIR}/README.md")
set(CPACK_PACKAGE_CONTACT "Roboticslab team at UC3M")

# Package version.
set(CPACK_PACKAGE_VERSION_MAJOR "${TEMPLATE_NAME_VERSION_MAJOR}")
set(CPACK_PACKAGE_VERSION_MINOR "${TEMPLATE_NAME_VERSION_MINOR}")
set(CPACK_PACKAGE_VERSION_PATCH "${TEMPLATE_NAME_VERSION_PATCH}")
...
if(WIN32 AND CMAKE_GENERATOR MATCHES "^Visual Studio")
    ...
    # Package name.
    set(CPACK_PACKAGE_FILE_NAME "TEMPLATE_LOWER_${CPACK_PACKAGE_VERSION}_${CPACK_SYSTEM_NAME}")

    # Miscellanea.
    set(CPACK_NSIS_HELP_LINK "http://github.com/roboticslab-uc3m/TEMPLATE_LOWER/")
...
if(UNIX)
    ...
    # Package name.
    set(CPACK_PACKAGE_FILE_NAME "TEMPLATE_LOWER-${CPACK_PACKAGE_VERSION}.${CPACK_SYSTEM_NAME}")
endif()
